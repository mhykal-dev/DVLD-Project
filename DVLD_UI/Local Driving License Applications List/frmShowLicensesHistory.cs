...
namespace DVLD_UI.Local_Driving_License_Applications_List
{
    public partial class frmShowLicensesHistory : Form
    {
        ...
        {
            dgvLocalLicensesHistory.DataSource = clsLicenses.GetAllLicensesForThisDriver(Driver.DriverID);
        }

        private void _RefreshInternationalLicensesList()
        {
            dgvInternationalLicensesHistory.DataSource = clsInternationalLicenses.GetAllLicensesForThisDriver(Driver.DriverID);
        }
