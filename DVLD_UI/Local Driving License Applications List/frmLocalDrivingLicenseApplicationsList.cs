...
namespace DVLD_UI.Local_Driving_License_Applications_List
{
    public partial class frmLocalDrivingLicenseApplicationsList : Form
    {
        ...
        {
            dgvLDLApplicationsList.DataSource = clsLocalDrivingLicenseApplications.GetAllLDLApplications();
        ...
        {
            dgvLDLApplicationsList.DataSource = clsLocalDrivingLicenseApplications.GetAllLDLApplicationsByFilter(cmbFilterBy.SelectedItem.ToString(), txtboxFilterField.Text.ToString());
        }
        ...
        private void visionTestToolStripMenuItem_Click(object sender, EventArgs e)
        {
            if (dgvLDLApplicationsList.SelectedRows.Count > 0)
            {
                ...
                int LDLApplicationID = Convert.ToInt32(dgvLDLApplicationsList.SelectedRows[0].Cells[0].Value);
        ...
        private void dgvLDLApplicationsList_SelectionChanged(object sender, EventArgs e)
        {
            ...
            if(dgvLDLApplicationsList.SelectedRows.Count > 0)
            {
                int PassedTests = Convert.ToInt32(dgvLDLApplicationsList.SelectedRows[0].Cells[5].Value);
