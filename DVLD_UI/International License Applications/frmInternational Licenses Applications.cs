...
namespace DVLD_UI.International_License_Applications
{
    ...
    public partial class frmInternational_Licenses_Applications : Form
    {
        ...
        private void _LoadApplication(object sender, int LicenseID, DateTime ExpirationDate, int DriverID, int IsActive)
        {
            ...
            lblApplicationFees.Text = clsApplicationTypes.GetApplicatinTypePrice(6).ToString();
        ...
        private void _SaveApplicationInFo()
        {
            ...
            application.ApplicantPersonID = clsDrivers.GetDriverPersonIDoByDriverID(_DriverID);
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            if (_LicenseID == clsInternationalLicenses.IsThereInternationalLicenseForThisLocalLicense(_LicenseID))
            {
                MessageBox.Show($"This Driver Have Already An InternationalLicense With ID {clsInternationalLicenses.FindByDriverID(_DriverID)}");
                return;
            }
